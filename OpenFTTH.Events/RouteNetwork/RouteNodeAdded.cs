...
namespace OpenFTTH.Events.RouteNetwork
{
    public class RouteNodeAdded : RouteElementAddedEvent
    {
        ...
        public RouteNodeAdded(string eventType, Guid eventId, string cmdType, Guid cmdId, bool isLastEventInCmd, Guid workTaskMrid, string userName, string? applicationName, string? applicationInfo, LifecyleInfo? lifecyleInfo, MappingInfo? mappingInfo, SafetyInfo? safetyInfo, Guid nodeId, string geometry, RouteNodeInfo? routeNodeInfo) 
