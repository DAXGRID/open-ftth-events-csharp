...
namespace OpenFTTH.Events.RouteNetwork
{
    public class RouteNodeGeometryModified : RouteNetworkEvent
    {
        ...
        public RouteNodeGeometryModified(string eventType, Guid eventId, DateTime eventTimestamp, string cmdType, Guid cmdId, bool isLastEventInCmd, Guid workTaskMrid, string userName, string? applicationName, string? applicationInfo, Guid nodeId, string geometry) 
