...
namespace OpenFTTH.Events.RouteNetwork
{
    public abstract class RouteElementAddedEvent : RouteNetworkEvent
    {
        ...
        public RouteElementAddedEvent(string eventType, Guid eventId, string cmdType, Guid cmdId, bool isLastEventInCmd, Guid workTaskMrid, string userName, string? applicationName, string? applicationInfo, NamingInfo? namingInfo, LifecycleInfo? lifecyleInfo, MappingInfo? mappingInfo, SafetyInfo? safetyInfo)
